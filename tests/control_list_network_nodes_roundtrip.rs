...
async fn control_list_network_nodes_returns_nodes_array() -> Result<()> {
    ...
    control.insert("list_network_nodes".to_string(), MethodAccessRule { access_rate: None });
